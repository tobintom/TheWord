...
public class EditHomeBibleNoteDialog extends DialogFragment {
    ...
    public EditHomeBibleNoteDialog(){
        super();
    }

    public static EditHomeBibleNoteDialog newInstance(BibleDBContent referenceCode, String displayVerses,
                                                      String bookName, String engName, String verse) {
        EditHomeBibleNoteDialog frag = new EditHomeBibleNoteDialog();

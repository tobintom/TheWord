...
public class CrossRefDialog extends DialogFragment {
    public static String TAG = "CrossReferencesDialog";
    ...
    public CrossRefDialog(){

    }

    public static CrossRefDialog newInstance(String referenceCode, String title) {
        CrossRefDialog frag = new CrossRefDialog();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_crossref, container);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            crossText = (TextView) view.findViewById(R.id.crosstxt);
            crossHint = (TextView) view.findViewById(R.id.crosstxthint);
            srchView = view.findViewById(R.id.idcross);
            ...
            if (code != null && code.trim().length() > 0) {
                ...
                //Service call to get references
                    new Thread(){
                        ...
                        public void run() {
                            try {
                                String searchData = TheWordContentService.getCrossReferences(sharedPreferences,getContext(),bookCode,chapterCode,verseCode);
                             ...
                             getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    if(hasData && !srchList.isEmpty()){
                                        ...
                                        crossHint.setText("No Cross References Found...");
                                    }
                                }
                            });
                        }

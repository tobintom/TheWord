...
public class BibleNoteAdapter extends RecyclerView.Adapter<BibleNoteAdapter.Viewholder> {
    ...
    public BibleNoteAdapter(Context context, List<BibleDBContent> noteList) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.biblenotescard, parent, false);
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
        ...
        holder.edit.setOnClickListener(v -> {
            EditBibleNoteDialog verseDialogFragment = null;
            try {
                fm = ((AppCompatActivity)context).getSupportFragmentManager();

                verseDialogFragment = EditBibleNoteDialog.newInstance(model, finalTitle);
                verseDialogFragment.show(fm, ViewVerseDialog.TAG);
            }catch (Exception e){
                verseDialogFragment.dismiss();
            }
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        public Viewholder(@NonNull View itemView) {
            super(itemView);
            bookTitle = itemView.findViewById(R.id.nbooktitle);
            bookLink = itemView.findViewById(R.id.nbooklink);
            bookEng = itemView.findViewById(R.id.nbookEng);
            bookVerse = itemView.findViewById(R.id.nbookVerses);
            noteTime = itemView.findViewById(R.id.nbookTime);
            verse = itemView.findViewById(R.id.nbookverse);
            note = itemView.findViewById(R.id.nbookNote);
            edit = itemView.findViewById(R.id.nbookEdit);
            delete = itemView.findViewById(R.id.nbookDelete);
        }
    }
}
